...
const slides = [
  ...
  },
  {
    ...
    bottomTitle:
      "Estratti puri per la tua cura quotidiana.",
  },
];
  ...
  return (
    <div className="relative order-1 lg:order-2">
      ...
      <motion.div
        ...
        className="relative ml-auto aspect-[3/2] w-full max-w-[650px] touch-pan-y cursor-grab overflow-hidden rounded-[2.5rem] rounded-bl-[5rem] border border-white/70 bg-[var(--soft-gray)] shadow-2xl shadow-black/10 active:cursor-grabbing lg:aspect-[4/3] lg:rounded-[4rem] lg:rounded-bl-[10rem]"
      >
        {/* Immagini */}
        <AnimatePresence>
          <motion.div
